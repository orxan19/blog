                ...
                <div class="col-md-8">
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            ...
                            <div class="social-share">
                                <span
                                        class="social-share-title pull-left text-capitalize">By {{$post->author->name}} On {{$post->getDate()}}
                                    <br> views:{{$post->views}}</span>
                    ...
                    <div class="bottom-comment"><!--bottom comment-->
                        ...
                        <div class="comment-img">
                            <img width="100px" class="img-circle" src="{{$comment->author->getImage()}}" alt="">
                        </div>
                    ...
                    <div class="leave-comment"><!--leave comment-->
                        ...
                        <div class="col-md-12">
                            ...
                            <button class="btn send-btn">Reply</button>
                        </form>
